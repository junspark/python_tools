...
datafile_pname = '/home/beams/S1BMUSER/Desktop/Data/parkjs/parkjs_dec14_edd/data/Al_Plug_Prototype'

###################################################
### PATH AND FILE NAME OF THE PAR FILE
logfile_pname = '/home/beams/S1BMUSER/Desktop/Data/parkjs/parkjs_dec14_edd'
logfile_fname = 'parkjs_jul14_edd_cat.pypar'
...
if testing_flag is False:
    ...
    mac.add_logging_PV('VP inst dead time','dp_vortex_xrd75:mca1.IDTIM')
    mac.add_logging_PV('VP ave dead time','dp_vortex_xrd75:mca1.DTIM')
    mac.add_logging_PV('VP real elap time','dp_vortex_xrd75:mca1.ERTM')
    mac.add_logging_PV('VP live elap time','dp_vortex_xrd75:mca1.ELTM')
