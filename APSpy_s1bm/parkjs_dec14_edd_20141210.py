...
datafile_pname = '/home/beams/S1BMUSER/Desktop/Data/parkjs/parkjs_dec14_edd/data/testing'

###################################################
### PATH AND FILE NAME OF THE PAR FILE
logfile_pname = '/home/beams/S1BMUSER/Desktop/Data/parkjs/parkjs_dec14_edd'
logfile_fname = 'parkjs_jul14_edd_test2.pypar'
...
### MCA DETECTOR SETUP
###################################################
horz_prefix = 'dp_vortex_xrd47:mca1'
...
vert_prefix = 'dp_vortex_xrd45:mca1'
...
if testing_flag is False:
    ...
    mac.add_logging_PV('HP inst dead time','dp_vortex_xrd47:mca1.IDTIM')
    mac.add_logging_PV('HP ave dead time','dp_vortex_xrd47:mca1.DTIM')
    mac.add_logging_PV('HP real elap time','dp_vortex_xrd47:mca1.ERTM')
    mac.add_logging_PV('HP live elap time','dp_vortex_xrd47:mca1.ELTM')
    #mac.add_logging_PV('VP inst dead time','dp_vortex_xrd45:mca1.IDTIM')
    #mac.add_logging_PV('VP ave dead time','dp_vortex_xrd45:mca1.DTIM')
    #mac.add_logging_PV('VP real elap time','dp_vortex_xrd45:mca1.ERTM')
    #mac.add_logging_PV('VP live elap time','dp_vortex_xrd45:mca1.ELTM')
