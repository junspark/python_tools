...
if testing_flag is True:
    ...
    mac.add_logging_PV('Undulator value', '1bmb:userCalc10.A')
    mac.add_logging_PV('Energy Nominal', '1bmb:userCalc10.A')
    mac.add_logging_PV('Energy Calibrated', '1bmb:userCalc10.A')
    mac.add_logging_PV('Foil Position', '1bmb:userCalc10.A')
    mac.add_logging_PV('Attenuator Position', '1bmb:userCalc10.A')
    
    mac.add_logging_PV('H det fname', '1edd:userStringSeq10.STR1')  ### NEED A PV
    mac.add_logging_PV('H det fnumber', '1bmb:userCalc10.A')        ### NEED A PV
    mac.add_logging_PV('H det frames per file', '1bmb:userCalc10.A')    ### NEED A PV
    ...
    mac.add_logging_PV('dummy det1 fname', '1edd:userStringSeq10.STR2') ### NEED A PV
    mac.add_logging_PV('dummy det1 fnumber', '1bmb:userCalc10.A')        ### NEED A PV
    mac.add_logging_PV('dummy det1 frames per file', '1bmb:userCalc10.A')    ### NEED A PV
    mac.add_logging_PV('dummy det1 time per frame', '1bmb:userCalc10.A')     ### NEED A PV
    
    mac.add_logging_PV('dummy det2 fname', '1edd:userStringSeq10.STR2') ### NEED A PV
    mac.add_logging_PV('dummy det2 fnumber', '1bmb:userCalc10.A')        ### NEED A PV
    mac.add_logging_PV('dummy det2 frames per file', '1bmb:userCalc10.A')    ### NEED A PV
    mac.add_logging_PV('dummy det2 time per frame', '1bmb:userCalc10.A')     ### NEED A PV
    
    mac.add_logging_PV('dummy det3 fname', '1edd:userStringSeq10.STR2') ### NEED A PV
    mac.add_logging_PV('dummy det3 fnumber', '1bmb:userCalc10.A')        ### NEED A PV
    mac.add_logging_PV('dummy det3 frames per file', '1bmb:userCalc10.A')    ### NEED A PV
    mac.add_logging_PV('dummy det3 time per frame', '1bmb:userCalc10.A')     ### NEED A PV
    
    mac.add_logging_PV('dummy det4 fname', '1edd:userStringSeq10.STR2') ### NEED A PV
    mac.add_logging_PV('dummy det4 fnumber', '1bmb:userCalc10.A')        ### NEED A PV
    mac.add_logging_PV('dummy det4 frames per file', '1bmb:userCalc10.A')    ### NEED A PV
    mac.add_logging_PV('dummy det4 time per frame', '1bmb:userCalc10.A')     ### NEED A PV
    
    mac.add_logging_PV('dummy det5 fname', '1edd:userStringSeq10.STR2') ### NEED A PV
    mac.add_logging_PV('dummy det5 fnumber', '1bmb:userCalc10.A')        ### NEED A PV
    mac.add_logging_PV('dummy det5 frames per file', '1bmb:userCalc10.A')    ### NEED A PV
    mac.add_logging_PV('dummy det5 time per frame', '1bmb:userCalc10.A')     ### NEED A PV
    
    mac.add_logging_PV('dummy det6 fname', '1edd:userStringSeq10.STR2') ### NEED A PV
    mac.add_logging_PV('dummy det6 fnumber', '1bmb:userCalc10.A')        ### NEED A PV
    mac.add_logging_PV('dummy det6 frames per file', '1bmb:userCalc10.A')    ### NEED A PV
    mac.add_logging_PV('dummy det6 time per frame', '1bmb:userCalc10.A')     ### NEED A PV
    
    mac.add_logging_PV('dummy det7 fname', '1edd:userStringSeq10.STR2') ### NEED A PV
    mac.add_logging_PV('dummy det7 fnumber', '1bmb:userCalc10.A')        ### NEED A PV
    mac.add_logging_PV('dummy det7 frames per file', '1bmb:userCalc10.A')    ### NEED A PV
    mac.add_logging_PV('dummy det7 time per frame', '1bmb:userCalc10.A')     ### NEED A PV
    
    mac.add_logging_PV('dummy det8 fname', '1edd:userStringSeq10.STR2') ### NEED A PV
    mac.add_logging_PV('dummy det8 fnumber', '1bmb:userCalc10.A')        ### NEED A PV
    mac.add_logging_PV('dummy det8 frames per file', '1bmb:userCalc10.A')    ### NEED A PV
    mac.add_logging_PV('dummy det8 time per frame', '1bmb:userCalc10.A')     ### NEED A PV
