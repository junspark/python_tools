...
# $Author: jemian $
# $Revision: 1281 $
# $URL: https://subversion.xray.aps.anl.gov/bcdaext/APSpy/branches/1id_afrl/src/testing/test_syn_macro.py $
# $Id: test_syn_macro.py 1281 2013-04-24 23:41:03Z jemian $
########### SVN repository information ###################
...
MOTOR_CONFIGURATION = '''
  samX   syn:m1     sample X position (mm) + outboard
  samZ   syn:m2     sample Z position (mm) + up
  phi    syn:m3     sample rotation (deg)
  j1     syn:m4     sample table N jack
  j2     syn:m5     sample table SE jack
  j3     syn:m6     sample table SW jack
'''
